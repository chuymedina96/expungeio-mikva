! function(n) {
    "use strict";
    n(".page-scroll a").bind("click", function(e) {
        var t = n(this);
        n("html, body").stop().animate({
            scrollTop: n(t.attr("href")).offset().top - 50
        }, 1250, "easeInOutExpo"), e.preventDefault()
    }), n("body").scrollspy({
        target: ".navbar-fixed-top",
        offset: 51
    }), n(".navbar-collapse ul li a").click(function() {
        n(".navbar-toggle:visible").click()
    }), n("#mainNav").affix({
        offset: {
            top: 100
        }
    ...
    $(".plusminus").parent().parent().click(function() {
        ...
        $("#fancy, #btn").fadeOut(1e3, function() {
            $("#bank, #btn-bk").fadeIn(1e3)
        })
        ...
        $("#btn-bk, #bank").fadeOut(1e3, function() {
            $("#btn-back").fadeIn(1e3), $("#container").fadeIn(1e3)
        })
        ...
        $("#container, #btn-back").fadeOut(1e3, function() {
            $("#results, #btn-backItUp").fadeIn(1e3)
        })
        ...
        $("#container, #btn-back").fadeOut(1e3, function() {
            $("#resultss, #btn-backItUpTwo").fadeIn(1e3)
        })
    ...
    $("#quoteButton").click(function(e) {
        function t() {
            $("#tweetQuote").attr("href", "https://twitter.com/intent/tweet?text='" + c + "' - " + u).attr("target", "_blank")
        }
        $("#quoteContainerr p").text(), $("#quoteGenius").text();
        e.preventDefault();
        var a = n.length,
        ...
        for (i = 0; i <= a; i += 1) {
            var c = n[o].quote,
                ...
                l = 600,
                r = $("#quoteContainerr");
            r.fadeOut(l, function() {
                r.html(""), r.append("<p>" + c + '</p><p id="quoteGenius">-' + u + "</p>"), r.fadeIn(l)
            }), t();
            break
        }
    })
